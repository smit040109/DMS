...
# Simple DMS router (fresh — /api/dms/*) — built before the copilot so the AI can
# answer using the logged-in user's own role-scoped DMS dashboards.
...
ai_copilot_router = build_ai_copilot_router(db, get_current_user, analytics_router, dms_router)
