...
const NAV_BY_ROLE = {
  ...
  salesperson: [
    ...
    { label: "Attendance",      to: "/dms/salesperson/attendance",     icon: "ClipboardList" },
    { label: "Expenses",        to: "/dms/expenses",                   icon: "Receipt" },
    { label: "Reports",         to: "/dms/reports",                    icon: "TrendingUp" },
  ],
  team_leader: [
  ...
  regional_manager: [
    ...
    { label: "My Retailers",      to: "/dms/regional-manager/retailers",         icon: "Store" },
    { label: "Attendance",        to: "/dms/regional-manager/attendance",        icon: "ClipboardList" },
